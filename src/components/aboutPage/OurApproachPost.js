...
import OurApproachGet from './OurApproachGet'
const OurMissionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/our-approach`, missionData, {
        headers: {
  ...
  return (
    <div style={containerStyle}>
      <h2 style={headingStyle}>Add Our Approach</h2>
